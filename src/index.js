        ...
        (async () => {
            ...
            try {
                ...
                if (!res.versions[packageJson.version]) {
                    console.warn('\x1b[1m[\x1b[96mAoi.backup\x1b[0m\x1b[1m] :: \x1b[93mThis is a dev version. Some stuff may be incomplete or unstable\x1b[0m');
                    return;
                }
                if (packageJson.version !== res["dist-tags"].latest) {
                    console.warn('\x1b[1m[\x1b[96mAoi.backup\x1b[0m\x1b[1m] :: \x1b[93mAoi.backup is outdated. Update to the latest version!\x1b[0m');
                }
            } catch (err) {
                console.error('\x1b[1m[\x1b[96mAoi.backup\x1b[0m\x1b[1m] :: \x1b[91mAn error occurred: \x1b[0m', err);
            }
